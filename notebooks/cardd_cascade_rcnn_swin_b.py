...
data_root = r'/home/pablo/repos/car-damage-vit/data/interim/cardd_coco/'

classes = ('dent', 'scratch', 'crack', 'glass shatter', 'tire flat', 'lamp broken')
metainfo = dict(classes=classes)

# =====================================================
# Modelo: Cascade R-CNN + FPN + Swin-B
# =====================================================
model = dict(
    type='CascadeRCNN',
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='https://download.openmmlab.com/mmclassification/v0/swin-transformer/swin-base_3rdparty_in1k_20221103-6dec57e1.pth'
        ),
    ),
    neck=dict(
        type='FPN',
...
train_pipeline = [
    ...
    dict(type='RandomChoiceResize', scales=[(1000, 667), (1000, 750), (1333, 800)], keep_ratio=True),
...
work_dir = './work_dirs/cardd_cascade_rcnn_swin_b'
