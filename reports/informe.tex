...
MobileViT-small y DeiT-tiny--- sobre el dataset CarDD, implementando una estrategia de
...
\begin{itemize}
  ...
  \item Evaluar una arquitectura mas compleja de segmentación de instancias (Mask2Former) con backbone SWIM \texttt{facebook/mask2former-swin-small-coco-instance} como posible mejora futura.
\end{itemize}
...
\textbf{Flujo operativo (8 etapas):}
\begin{enumerate}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{model_train.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{model_eval.jpeg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{mask2former-swim-train-loss.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{mask2former-swim-val.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.96\textwidth]{mask2former-swim-examples.png}
